...
VALUES ('Afghanistan', 'AF/flat/64.png'),
       ('Albania', 'AL/flat/64.png'),
       ('Algeria', 'DZ/flat/64.png'),
       ('Andorra', 'AD/flat/64.png'),
       ('Angola', 'AO/flat/64.png'),
       ('Antigua and Barbuda', 'AG/flat/64.png'),
       ('Argentina', 'AR/flat/64.png'),
       ('Armenia', 'AM/flat/64.png'),
       ('Australia', 'AU/flat/64.png'),
       ('Austria', 'AT/flat/64.png'),
       ('Azerbaijan', 'AZ/flat/64.png'),
       ('Bahamas', 'BS/flat/64.png'),
       ('Bahrain', 'BH/flat/64.png'),
       ('Bangladesh', 'BD/flat/64.png'),
       ('Barbados', 'BB/flat/64.png'),
       ('Belarus', 'BY/flat/64.png'),
       ('Belgium', 'BE/flat/64.png'),
       ('Belize', 'BZ/flat/64.png'),
       ('Benin', 'BJ/flat/64.png'),
       ('Bhutan', 'BT/flat/64.png'),
       ('Bolivia', 'BO/flat/64.png'),
       ('Bosnia and Herzegovina', 'BA/flat/64.png'),
       ('Botswana', 'BW/flat/64.png'),
       ('Brazil', 'BR/flat/64.png'),
       ('Brunei', 'BN/flat/64.png'),
       ('Bulgaria', 'BG/flat/64.png'),
       ('Burkina Faso', 'BF/flat/64.png'),
       ('Burundi', 'BI/flat/64.png'),
       ('Cabo Verde', 'CV/flat/64.png'),
       ('Cambodia', 'KH/flat/64.png'),
       ('Cameroon', 'CM/flat/64.png'),
       ('Canada', 'CA/flat/64.png'),
       ('Central African Republic', 'CF/flat/64.png'),
       ('Chad', 'TD/flat/64.png'),
       ('Chile', 'CL/flat/64.png'),
       ('China', 'CN/flat/64.png'),
       ('Colombia', 'CO/flat/64.png'),
       ('Comoros', 'KM/flat/64.png'),
       ('Costa Rica', 'CR/flat/64.png'),
       ('Croatia', 'HR/flat/64.png'),
       ('Cuba', 'CU/flat/64.png'),
       ('Cyprus', 'CY/flat/64.png'),
       ('Czech Republic', 'CZ/flat/64.png'),
       ('Democratic Republic of the Congo', 'CD/flat/64.png'),
       ('Denmark', 'DK/flat/64.png'),
       ('Djibouti', 'DJ/flat/64.png'),
       ('Dominica', 'DM/flat/64.png'),
       ('Dominican Republic', 'DO/flat/64.png'),
       ('East Timor (Timor-Leste)', 'TL/flat/64.png'),
       ('Ecuador', 'EC/flat/64.png'),
       ('Egypt', 'EG/flat/64.png'),
       ('El Salvador', 'SV/flat/64.png'),
       ('Equatorial Guinea', 'GQ/flat/64.png'),
       ('Eritrea', 'ER/flat/64.png'),
       ('Estonia', 'EE/flat/64.png'),
       ('Ethiopia', 'ET/flat/64.png'),
       ('Fiji', 'FJ/flat/64.png'),
       ('Finland', 'FI/flat/64.png'),
       ('France', 'FR/flat/64.png'),
       ('Gabon', 'GA/flat/64.png'),
       ('Gambia', 'GM/flat/64.png'),
       ('Georgia', 'GE/flat/64.png'),
       ('Germany', 'DE/flat/64.png'),
       ('Ghana', 'GH/flat/64.png'),
       ('Greece', 'GR/flat/64.png'),
       ('Grenada', 'GD/flat/64.png'),
       ('Guatemala', 'GT/flat/64.png'),
       ('Guinea', 'GN/flat/64.png'),
       ('Guinea-Bissau', 'GW/flat/64.png'),
       ('Guyana', 'GY/flat/64.png'),
       ('Haiti', 'HT/flat/64.png'),
       ('Honduras', 'HN/flat/64.png'),
       ('Hungary', 'HU/flat/64.png'),
       ('Iceland', 'IS/flat/64.png'),
       ('India', 'IN/flat/64.png'),
       ('Indonesia', 'ID/flat/64.png'),
       ('Iran', 'IR/flat/64.png'),
       ('Iraq', 'IQ/flat/64.png'),
       ('Ireland', 'IE/flat/64.png'),
       ('Israel', 'IL/flat/64.png'),
       ('Italy', 'IT/flat/64.png'),
       ('Jamaica', 'JM/flat/64.png'),
       ('Japan', 'JP/flat/64.png'),
       ('Jordan', 'JO/flat/64.png'),
       ('Kazakhstan', 'KZ/flat/64.png'),
       ('Kenya', 'KE/flat/64.png'),
       ('Kiribati', 'KI/flat/64.png'),
       ('Kuwait', 'KW/flat/64.png'),
       ('Kyrgyzstan', 'KG/flat/64.png'),
       ('Laos', 'LA/flat/64.png'),
       ('Latvia', 'LV/flat/64.png'),
       ('Lebanon', 'LB/flat/64.png'),
       ('Lesotho', 'LS/flat/64.png'),
       ('Liberia', 'LR/flat/64.png'),
       ('Libya', 'LY/flat/64.png'),
       ('Liechtenstein', 'LI/flat/64.png'),
       ('Lithuania', 'LT/flat/64.png'),
       ('Luxembourg', 'LU/flat/64.png'),
       ('Madagascar', 'MG/flat/64.png'),
       ('Malawi', 'MW/flat/64.png'),
       ('Malaysia', 'MY/flat/64.png'),
       ('Maldives', 'MV/flat/64.png'),
       ('Mali', 'ML/flat/64.png'),
       ('Malta', 'MT/flat/64.png'),
       ('Marshall Islands', 'MH/flat/64.png'),
       ('Mauritania', 'MR/flat/64.png'),
       ('Mauritius', 'MU/flat/64.png'),
       ('Mexico', 'MX/flat/64.png'),
       ('Micronesia', 'FM/flat/64.png'),
       ('Moldova', 'MD/flat/64.png'),
       ('Monaco', 'MC/flat/64.png'),
       ('Mongolia', 'MN/flat/64.png'),
       ('Montenegro', 'ME/flat/64.png'),
       ('Morocco', 'MA/flat/64.png'),
       ('Mozambique', 'MZ/flat/64.png'),
       ('Myanmar', 'MM/flat/64.png'),
       ('Namibia', 'NA/flat/64.png'),
       ('Nauru', 'NR/flat/64.png'),
       ('Nepal', 'NP/flat/64.png'),
       ('Netherlands', 'NL/flat/64.png'),
       ('New Zealand', 'NZ/flat/64.png'),
       ('Nicaragua', 'NI/flat/64.png'),
       ('Niger', 'NE/flat/64.png'),
       ('Nigeria', 'NG/flat/64.png'),
       ('North Korea', 'KP/flat/64.png'),
       ('North Macedonia', 'MK/flat/64.png'),
       ('Norway', 'NO/flat/64.png'),
       ('Oman', 'OM/flat/64.png'),
       ('Pakistan', 'PK/flat/64.png'),
       ('Palau', 'PW/flat/64.png'),
       ('Panama', 'PA/flat/64.png'),
       ('Papua New Guinea', 'PG/flat/64.png'),
       ('Paraguay', 'PY/flat/64.png'),
       ('Peru', 'PE/flat/64.png'),
       ('Philippines', 'PH/flat/64.png'),
       ('Poland', 'PL/flat/64.png'),
       ('Portugal', 'PT/flat/64.png'),
       ('Qatar', 'QA/flat/64.png'),
       ('Romania', 'RO/flat/64.png'),
       ('Russia', 'RU/flat/64.png'),
       ('Rwanda', 'RW/flat/64.png'),
       ('Saint Kitts and Nevis', 'KN/flat/64.png'),
       ('Saint Lucia', 'LC/flat/64.png'),
       ('Saint Vincent and the Grenadines', 'VC/flat/64.png'),
       ('Samoa', 'WS/flat/64.png'),
       ('San Marino', 'SM/flat/64.png'),
       ('Sao Tome and Principe', 'ST/flat/64.png'),
       ('Saudi Arabia', 'SA/flat/64.png'),
       ('Senegal', 'SN/flat/64.png'),
       ('Serbia', 'RS/flat/64.png'),
       ('Seychelles', 'SC/flat/64.png'),
       ('Sierra Leone', 'SL/flat/64.png'),
       ('Singapore', 'SG/flat/64.png'),
       ('Slovakia', 'SK/flat/64.png'),
       ('Slovenia', 'SI/flat/64.png'),
       ('Solomon Islands', 'SB/flat/64.png'),
       ('Somalia', 'SO/flat/64.png'),
       ('South Africa', 'ZA/flat/64.png'),
       ('South Korea', 'KR/flat/64.png'),
       ('South Sudan', 'SS/flat/64.png'),
       ('Spain', 'ES/flat/64.png'),
       ('Sri Lanka', 'LK/flat/64.png'),
       ('Sudan', 'SD/flat/64.png'),
       ('Suriname', 'SR/flat/64.png'),
       ('Sweden', 'SE/flat/64.png'),
       ('Switzerland', 'CH/flat/64.png'),
       ('Syria', 'SY/flat/64.png'),
       ('Taiwan', 'TW/flat/64.png'),
       ('Tajikistan', 'TJ/flat/64.png'),
       ('Tanzania', 'TZ/flat/64.png'),
       ('Thailand', 'TH/flat/64.png'),
       ('Togo', 'TG/flat/64.png'),
       ('Tonga', 'TO/flat/64.png'),
       ('Trinidad and Tobago', 'TT/flat/64.png'),
       ('Tunisia', 'TN/flat/64.png'),
       ('Turkey', 'TR/flat/64.png'),
       ('Turkmenistan', 'TM/flat/64.png'),
       ('Tuvalu', 'TV/flat/64.png'),
       ('Uganda', 'UG/flat/64.png'),
       ('Ukraine', 'UA/flat/64.png'),
       ('United Arab Emirates', 'AE/flat/64.png'),
       ('United Kingdom', 'GB/flat/64.png'),
       ('United States of America', 'US/flat/64.png'),
       ('Uruguay', 'UY/flat/64.png'),
       ('Uzbekistan', 'UZ/flat/64.png'),
       ('Vanuatu', 'VU/flat/64.png'),
       ('Vatican City', 'VA/flat/64.png'),
       ('Venezuela', 'VE/flat/64.png'),
       ('Vietnam', 'VN/flat/64.png'),
       ('Yemen', 'YE/flat/64.png'),
       ('Zambia', 'ZM/flat/64.png'),
       ('Zimbabwe', 'ZW/flat/64.png');
...
SELECT 'Yves Saint Laurent',
       'saintlaurent_syn9c2.jpg',
       (SELECT country_id FROM country WHERE name = 'France'),
       (SELECT company_id FROM company WHERE name = 'L’Oréal');
INSERT INTO brand (name, image_url, country_id, company_id)
SELECT 'Paco Rabanne',
       'pacorabanne_w9uajh.png',
...
SELECT 'Maison Francis Kurkdjian',
       'maisonfranciskurkdjian_xuzc5a.jpg',
       (SELECT country_id FROM country WHERE name = 'France'),
       (SELECT company_id FROM company WHERE name = 'LVMH');
